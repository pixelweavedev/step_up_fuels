...
class ResponsiveDimensions {
  ...
  static double masterListWidth(BuildContext context) => ResponsiveLayout.value(
    context,
    desktop: 380,
    tablet: 300,
    smallTablet: 260,
  ...
  static double navWidth(BuildContext context) => ResponsiveLayout.value(
    context,
    desktop: 240,
    tablet: 80,
    smallTablet: 72,
  ...
  static double dialogMaxWidth(BuildContext context) => ResponsiveLayout.value(
    context,
    desktop: 640,
    tablet: 560,
    smallTablet: 480,
