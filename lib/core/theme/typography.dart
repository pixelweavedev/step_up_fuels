...
class AppTypography {
  ...
  static TextStyle pageTitle(BuildContext context) {
    ...
    final size = context.responsiveValue(desktop: 22.0, tablet: 20.0, mobile: 18.0);
  ...
  static TextStyle sectionTitle(BuildContext context) {
    ...
    final size = context.responsiveValue(desktop: 18.0, tablet: 16.0, mobile: 14.0);
    return style.copyWith(fontSize: size);
  }
  ...
  static TextStyle cardTitle(BuildContext context) {
    ...
    final size = context.responsiveValue(desktop: 16.0, tablet: 15.0, mobile: 14.0);
    return style.copyWith(fontSize: size);
  }
  ...
  static TextStyle metricValue(BuildContext context) {
    ...
    final size = context.responsiveValue(desktop: 28.0, tablet: 24.0, mobile: 20.0);
    return style.copyWith(fontSize: size);
  }
  ...
  static TextStyle caption(BuildContext context) {
    ...
    final size = context.responsiveValue(desktop: 12.0, tablet: 11.0, mobile: 11.0);
    return style.copyWith(fontSize: size);
  }
}
