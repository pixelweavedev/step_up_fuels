...
class DashboardServiceImpl implements DashboardService {
  ...
  Future<Result<DashboardStats>> getTodayStats() async {
    try {
      ...
      final int todayDeliveriesCount = todayInvoices.length;
      ...
      final totalOutstandingReceivables =
          (await custOutstandingQuery
