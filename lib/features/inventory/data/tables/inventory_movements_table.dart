...
class InventoryMovements extends Table {
  ...
  TextColumn get sourceLocationId => text().nullable().references(StorageLocations, #id)();
  TextColumn get destinationLocationId => text().nullable().references(StorageLocations, #id)();
  TextColumn get type => text()(); // PURCHASE_IN, BOWSER_LOAD, DELIVERY_OUT, ADJUSTMENT_GAIN, ADJUSTMENT_LOSS, OPENING_STOCK
  RealColumn get quantity => real()(); // Always positive quantity
  TextColumn get referenceId => text().nullable()(); // FK to invoice, purchase, delivery, etc.
  TextColumn get referenceType => text().nullable()(); // INVOICE, PURCHASE, DELIVERY, ADJUSTMENT
